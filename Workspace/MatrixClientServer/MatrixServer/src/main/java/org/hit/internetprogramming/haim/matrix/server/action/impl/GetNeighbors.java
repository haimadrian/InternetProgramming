 ...
 * @since 23-Apr-21
 */
public class GetNeighbors implements Action {
    @Override
    public Response execute(ActionContext actionContext) {
        ...
        return Response.ok(HttpStatus.OK.getCode(), graph.getAdjacentVertices(actionContext.getRequest().getVertex()), actionContext.getRequest().isHttpRequest());
    }
}
